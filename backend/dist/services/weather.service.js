...
exports.buildWeatherContext = exports.getDestinationWeather = void 0;
...
const interpretWeatherCode = (code) => {
    ...
    if (code <= 2)
        return { condition: 'sunny', description: 'Mainly clear' };
    if (code === 3)
        return { condition: 'cloudy', description: 'Overcast' };
    if (code <= 49)
        return { condition: 'cloudy', description: 'Foggy or hazy' };
    if (code <= 69)
        return { condition: 'rainy', description: 'Drizzle or light rain' };
    if (code <= 79)
        return { condition: 'rainy', description: 'Snow or sleet' };
    if (code <= 82)
        return { condition: 'rainy', description: 'Rain showers' };
    if (code <= 86)
        return { condition: 'mixed', description: 'Snow showers' };
    if (code <= 99)
...
exports.getDestinationWeather = getDestinationWeather;
...
const buildWeatherContext = (weather) => {
    ...
    const activityHint = weather.condition === 'rainy'
...
exports.buildWeatherContext = buildWeatherContext;
